  ...
  function placeCards(){
   ...
   if(placedCardsArray.length < 1) {audio5.play();
  ...
  let imgsEl = document.getElementsByClassName('cards-all')
    ...
    timer2 = setInterval(revealCard, 50)
    function revealCard(){
...
// sound for shuffle 
var audio5 = new Audio("shuffle four rows testb.mp3")
...
//if (timer < 0 && paraNum > 0){ timer += 60}
//if (timer === 0 && paraNum > 0){paraNum--;}
