...
let jsDocAgeEl = document.getElementById('js-documentation-age');
let jruggedAgeEl = document.getElementById('rugged-instruments-age');
let originalTrombonesAgeEl = document.getElementById('music-page-age');
let musicPageAgeEl = document.getElementById('original-trombones-age');
let peopleCounterAgeEl = document.getElementById('people-counter-age');
let firstResponsiveAgeEl = document.getElementById('first-responsive-age');

// object contains game age and element for rendering age
let sitesCreatedObj = {
   ruggedSiteCreated :['2021/08/29', jruggedAgeEl],
   jsDocSiteCreated :['2021/09/26', jsDocAgeEl],
   musicPageCreated :['2021/09/01', musicPageAgeEl],
   originalTrombonesCreated :['2021/09/21', originalTrombonesAgeEl],   
   firstResponsiveCreated :['2021/09/12', firstResponsiveAgeEl], 
   peopleCounterCreated :['2021/12/02', peopleCounterAgeEl],
    
}

let sitesAgeArr = Object.keys(sitesCreatedObj)
...
const sitesAge = (sitesAgeArr) =>{
    sitesAgeArr.forEach(ImageApp =>{
...
let published = new Date(sitesCreatedObj[`${ImageApp}`][0]); // date format
...
sitesCreatedObj[`${ImageApp}`][1].textContent = age;


});
}
sitesAge(sitesAgeArr)