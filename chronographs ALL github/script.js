...
let stopwatchBasicAgeEl = document.getElementById('stopwatch_basic_age')
let stopwatchLapAgeEl = document.getElementById('stopwatch_lap_age')
let stopwatchFullAgeEl = document.getElementById('stopwatch_full_age')
let chronographAnalogueAgeEl = document.getElementById('chronograph_analogue_age')
let chronographDigitalAgeEl = document.getElementById('chronograph_digital_age')
let chronographBasicAgeEl = document.getElementById('chronograph_basic_age')



let chronographAppsCreatedObj = {
    stopwatchBasicCreated :['2022/09/13', stopwatchBasicAgeEl],
    stopwatchLapCreated :['2022/09/13', stopwatchLapAgeEl],
    stopwatchFullCreated :['2022/10/22', stopwatchFullAgeEl],
   chronographAnalogueCreated :['2022/12/11', chronographAnalogueAgeEl],
   chronographDigitalCreated :['2023/02/25', chronographDigitalAgeEl],
}


let chronographAppAgeArr = Object.keys(chronographAppsCreatedObj)
...
const chronographAppAge = (chronographAppDates) =>{
 chronographAppDates.forEach(chronographApp =>{
...
let published = new Date(chronographAppsCreatedObj[`${chronographApp}`][0]); // date format
...
chronographAppsCreatedObj[`${chronographApp}`][1].textContent = age;

})}

chronographAppAge(chronographAppAgeArr)
