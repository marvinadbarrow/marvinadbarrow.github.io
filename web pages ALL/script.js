...
let earlySitesAgeEl = document.getElementById('early-sites-age');
let newerSitesAgeEl = document.getElementById('newer-sites-age');

// object contains game age and element for rendering age
let sitesCreatedObj = {
    earlySitesCreated :['2021/08/30', earlySitesAgeEl],
   newerSitesCreated :['2023/07/10', newerSitesAgeEl]   
}
