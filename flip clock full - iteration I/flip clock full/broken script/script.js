...
console.log('reversing...')
  ...
  frontTopHours.style.backgroundImage =  backTopHours.style.backgroundImage
...
const bottomHalfMins = () =>{
  console.log('rotate bottom...')
  frontBottomMins.style.animationDuration = '0.4s'
  frontBottomMins.style.animationFillMode = 'forwards'
...
const updateBackTopTens = () =>{
  ...
  let headingEl = document.getElementById('heading-container')
